...
<div class="row">
 <div class="col-lg-12">
    <ol class="breadcrumb">
     <li class="active">
        <i class="fa fa-dashboard"></i> Insert User 
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <label class="col-md-3 control-label">User Occupation</label>
                      <div class="col-md-6">
                       <input type="text" name="admin_occupation" class="form-control" required>
                      </div>
                  </div>
                    ...
                    <label class="col-md-3 control-label"></label>
                      <div class="col-md-6">
                       <input type="submit" name="submit" value="Insert User" class="form-control btn btn-success" required>
                      </div>
                  </div>
                </form>
...
$insert_admin = "INSERT into admin (admin_name, admin_email, admin_password, admin_image, admin_contact, admin_country, admin_occupation, admin_about) 

values ('$admin_name', '$admin_email', '$admin_password', '$admin_image', '$admin_contact', '$admin_country', '$admin_occupation', '$admin_about')";    
